  ...
  _createClass__default["default"](TableTreeStore, [{
    ...
    value: function getAllUniqueKeys(data, keys) {
      ...
      for (var i = 0, len = data.length; i < len; i++) {
        var item = data[i];
        arr.push(get__default["default"](item, keys.rowKey));
    ...
    value: function updateData(rowValue, newRowData, dataSource, keys) {
      var newRowValue = get__default["default"](newRowData, keys.rowKey);
      ...
      if (get__default["default"](newRowData, keys.childrenKey) === true) {
        ...
        if (oldChildren !== null && oldChildren !== void 0 && oldChildren.length) {
          for (var i = 0, len = oldChildren.length; i < len; i++) {
            var rowValue2 = get__default["default"](oldChildren[i], keys.rowKey);
      ...
      if (rowState.parent) {
        ...
        var index = siblings.findIndex(function (item) {
          return get__default["default"](item, keys.rowKey) === rowValue;
        });
    ...
    value: function appendTo(rowValue, newData, dataSource, keys) {
      ...
      for (var i = 0, len = tmpData.length; i < len; i++) {
        ...
        var newRowValue = get__default["default"](oneData, keys.rowKey);

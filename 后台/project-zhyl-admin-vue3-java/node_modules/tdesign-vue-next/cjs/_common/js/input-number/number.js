...
function formatToNumber(num, extra) {
  ...
  var isLargeNumber = (extra === null || extra === void 0 ? void 0 : extra.largeNumber) && isString__default["default"](num);
  var newNumber = num;
  if (isString__default["default"](num) && num.includes("e") || isNumber__default["default"](num)) {

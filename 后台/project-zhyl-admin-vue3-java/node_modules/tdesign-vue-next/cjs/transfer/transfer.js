...
var _Transfer = vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var checkedValue = vue.computed(function () {
      var _ref2;
      return _ref2 = {}, _defineProperty__default["default"](_ref2, SOURCE, transfer_utils.getDataValues(sourceList.value, innerChecked.value, {
        isTreeMode: isTreeMode.value
      })), _defineProperty__default["default"](_ref2, TARGET, transfer_utils.getDataValues(targetList.value, innerChecked.value, {
        isTreeMode: isTreeMode.value
      })), _ref2;
    });
    ...
    return function () {
      ...
      }, [renderTransferList(SOURCE), vue.createVNode(transfer_components_transferOperations["default"], {

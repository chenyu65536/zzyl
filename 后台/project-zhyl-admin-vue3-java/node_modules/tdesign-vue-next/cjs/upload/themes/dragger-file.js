...
var DraggerFile = vue.defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var renderImage = function renderImage() {
      ...
      }, [url && vue.createVNode(imageViewer_index.ImageViewer, {
        "images": [url],
    ...
    var renderMainPreview = function renderMainPreview() {
      ...
      }, [["progress", "waiting"].includes(file.status) && !disabled && vue.createVNode(link_index.Link, {
        "theme": "primary",
        "hover": "color",
      ...
      }), !props.autoUpload && file.status === "waiting" && vue.createVNode(link_index.Link, {
        "theme": "primary",
        "hover": "color",

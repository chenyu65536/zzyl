  ...
  setup: function setup(props, _ref) {
    ...
    var renderImgItem = function renderImgItem(file, index) {
      ...
      return vue.createVNode("li", {
        ...
        "class": classNames(["".concat(uploadPrefix, "__card-content"), _defineProperty__default["default"]({}, "".concat(classPrefix.value, "-is-bordered"), file.status !== "waiting")])
    ...
    var renderNormalActionCol = function renderNormalActionCol(file, index) {
      ...
      return vue.createVNode("td", null, [vue.createVNode(link_index.Link, {
        "theme": "primary",
        "hover": "color",
    ...
    var renderBatchActionCol = function renderBatchActionCol(index) {
      ...
      }, [vue.createVNode(link_index.Link, {
        "theme": "primary",
        "hover": "color",
    ...
    var renderFileList = function renderFileList() {
      ...
      return vue.createVNode("table", vue.mergeProps({
        ...
        return vue.createVNode("tr", {
          "key": file.name + index
        }, [vue.createVNode("td", null, [file.url ? vue.createVNode(link_index.Link, {
          "href": file.url,
          "target": "_blank",
          "hover": "color"

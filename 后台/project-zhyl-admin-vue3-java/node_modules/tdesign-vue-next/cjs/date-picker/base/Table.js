...
var TDateTable = vue.defineComponent({
  ...
  setup: function setup(props) {
    ...
    var weekRowClass = function weekRowClass(value, format, targetValue) {
      ...
      return _defineProperty__default["default"]({}, "".concat(COMPONENT_NAME.value, "-").concat(props.mode, "-row--active"), _common_js_datePicker_format.parseToDayjs(value, format).week() === _common_js_datePicker_format.parseToDayjs(targetValue, format).week());
    };
    return function () {

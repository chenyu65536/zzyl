...
function useDragSort(props, context) {
  ...
  vue.watch([data], function (_ref) {
    ...
    lastRowList.value = (data2 === null || data2 === void 0 ? void 0 : data2.map(function (item) {
      return get__default["default"](item, rowKey.value);
    })) || [];
  }, {
    immediate: true
  });
  ...
  var registerRowDragEvent = function registerRowDragEvent(element) {
    ...
    var baseOptions = _objectSpread({
      ...
      onEnd: function onEnd(evt) {
        ...
        if (isFunction__default["default"](props.firstFullRow) && props.firstFullRow(vue.h) || context.slots.firstFullRow) {
          currentIndex -= 1;
          targetIndex -= 1;
        }
        var params = {
          ...
          newData: _common_js_utils_swapDragArrayElement["default"](_toConsumableArray__default["default"](props.data), getDataPageIndex(currentIndex), getDataPageIndex(targetIndex)),
          e: evt,
          sort: "row"
        };
    ...
    var options = _objectSpread(_objectSpread({
      ...
      onEnd: function onEnd(evt) {
        ...
        if (recover) {
          ...
          (_dragInstanceTmp2 = dragInstanceTmp) === null || _dragInstanceTmp2 === void 0 ? void 0 : _dragInstanceTmp2.sort(_toConsumableArray__default["default"](lastColList.value));
        }
        ...
        var current = table_utils.getColumnDataByKey(columns.value, oldElement.dataset.colkey);
        var target = table_utils.getColumnDataByKey(columns.value, newElement.dataset.colkey);
        ...
        currentIndex = table_utils.getColumnIndexByKey(props.columns, current.colKey);
        targetIndex = table_utils.getColumnIndexByKey(props.columns, target.colKey);
        var params = {
          data: columns.value,
          currentIndex: currentIndex,
          current: current,

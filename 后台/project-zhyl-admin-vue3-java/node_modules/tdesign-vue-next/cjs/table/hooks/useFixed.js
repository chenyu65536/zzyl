...
function getColumnFixedStyles(col, index, rowAndColFixedPosition, tableColFixedClasses) {
  ...
  if (!fixedPos) return {};
  var thClasses = (_thClasses = {}, _defineProperty__default["default"](_thClasses, tableColFixedClasses.left, col.fixed === "left"), _defineProperty__default["default"](_thClasses, tableColFixedClasses.right, col.fixed === "right"), _defineProperty__default["default"](_thClasses, tableColFixedClasses.lastLeft, col.fixed === "left" && fixedPos.lastLeftFixedCol), _defineProperty__default["default"](_thClasses, tableColFixedClasses.firstRight, col.fixed === "right" && fixedPos.firstRightFixedCol), _thClasses);
  var thStyles = {
...
function getRowFixedStyles(rowId, rowIndex, rowLength, fixedRows, rowAndColFixedPosition, tableRowFixedClasses) {
  ...
  var rowClasses = (_rowClasses = {}, _defineProperty__default["default"](_rowClasses, tableRowFixedClasses.top, fixedTop), _defineProperty__default["default"](_rowClasses, tableRowFixedClasses.bottom, fixedBottom), _defineProperty__default["default"](_rowClasses, tableRowFixedClasses.firstBottom, rowIndex === firstFixedBottomRow), _defineProperty__default["default"](_rowClasses, tableRowFixedClasses.withoutBorderBottom, rowIndex === firstFixedBottomRow - 1), _rowClasses);
  var rowStyles = {
...
function useFixed(props, context, finalColumns, affixRef) {
  ...
  var refreshTable = debounce__default["default"](function () {
    updateTableWidth();
    updateFixedHeader();
    updateThWidthListHandler();
    updateAffixPosition();

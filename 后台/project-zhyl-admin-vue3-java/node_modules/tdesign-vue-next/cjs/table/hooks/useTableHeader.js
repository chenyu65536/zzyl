...
function useTableHeader(props) {
  ...
  var renderTitleWidthIcon = function renderTitleWidthIcon(_ref, col, colIndex, ellipsisTitle, attach, extra) {
    ...
    var _ref2 = _slicedToArray__default["default"](_ref, 3),
      ...
      sortIcon = _ref2[1],
      filterIcon = _ref2[2];
    var classes = (_classes = {}, _defineProperty__default["default"](_classes, tableSortClasses.sortable, sortIcon), _defineProperty__default["default"](_classes, tableFilterClasses.filterable, filterIcon), _classes);

...
var EditableCell = vue.defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var currentRow = vue.computed(function () {
      ...
      lodashSet__default["default"](newRow, col.value.colKey, editValue.value);
      return newRow;
    });
    ...
    var componentProps = vue.computed(function () {
      ...
      if (!edit) return {};
      var editProps = isFunction__default["default"](edit.props) ? edit.props(_objectSpread(_objectSpread({}, cellParams.value), {}, {
    ...
    vue.watch(cellValue, function (cellValue2) {
      ...
      if (_typeof__default["default"](val) === "object" && val !== null) {
        val = val instanceof Array ? _toConsumableArray__default["default"](val) : _objectSpread({}, val);
      }
      editValue.value = val;
    }, {
      immediate: true

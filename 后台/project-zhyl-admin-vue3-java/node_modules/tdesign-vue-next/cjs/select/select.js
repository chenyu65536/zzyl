...
var _Select = vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var _useSelectOptions = select_hooks_useSelectOptions.useSelectOptions(props2, keys),
    ...
    var setInnerValue = function setInnerValue(newVal, e) {
      if (props2.valueType === "object") {
        ...
        var getOption = function getOption(val) {
          ...
          return _ref2 = {}, _defineProperty__default["default"](_ref2, value2, get__default["default"](option, value2)), _defineProperty__default["default"](_ref2, label, get__default["default"](option, label)), _ref2;
        };
    ...
    var valueDisplayParams = vue.computed(function () {
      return props2.multiple && isArray__default["default"](innerValue.value) ? innerValue.value.map(function (value2) {
    ...
    vue.provide(select_helper.selectInjectKey, SelectProvide);
    ...
    var handleSearch = debounce__default["default"](function (value2) {
    ...
    return function () {
      var _ref4 = props2.popupProps || {},
        ...
        restPopupProps = _objectWithoutProperties__default["default"](_ref4, _excluded2);

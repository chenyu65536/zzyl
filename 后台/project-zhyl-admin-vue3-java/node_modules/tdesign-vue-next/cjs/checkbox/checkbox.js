...
var _Checkbox = vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var checkboxGroup = vue.inject(checkbox_constants.CheckboxGroupInjectionKey, void 0);
    ...
    var labelClasses = vue.computed(function () {
      var _ref;
      return ["".concat(COMPONENT_NAME.value), (_ref = {}, _defineProperty__default["default"](_ref, "".concat(classPrefix.value, "-is-checked"), selfChecked.value), _defineProperty__default["default"](_ref, "".concat(classPrefix.value, "-is-disabled"), disabled.value), _defineProperty__default["default"](_ref, "".concat(classPrefix.value, "-is-indeterminate"), selfIndeterminate.value), _ref)];
    });

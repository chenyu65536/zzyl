...
function getNodeStatusClass(node, STATUS, cascaderContext) {
  ...
  return [(_ref2 = {}, _defineProperty__default["default"](_ref2, STATUS.selected, !isDisabled && isSelected), _defineProperty__default["default"](_ref2, STATUS.expanded, !isDisabled && expandedActive), _defineProperty__default["default"](_ref2, STATUS.disabled, isDisabled), _ref2)];
}
function getCascaderItemClass(prefix, node, SIZE, STATUS, cascaderContext) {
  var _ref3;
  var size = cascaderContext.size;
  return ["".concat(prefix, "-cascader__item")].concat(_toConsumableArray__default["default"](getNodeStatusClass(node, STATUS, cascaderContext)), [SIZE[size], (_ref3 = {}, _defineProperty__default["default"](_ref3, "".concat(prefix, "-cascader__item--with-icon"), !!node.children), _defineProperty__default["default"](_ref3, "".concat(prefix, "-cascader__item--leaf"), node.isLeaf()), _ref3)]);
}

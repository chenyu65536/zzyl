  ...
  setup: function setup(props2, ctx) {
    ...
    var sliderClass = vue.computed(function () {
      ...
      return ["".concat(COMPONENT_NAME.value), (_ref = {
        "is-vertical": vertical.value
      }, _defineProperty__default["default"](_ref, "".concat(COMPONENT_NAME.value, "--with-input"), props2.inputNumberProps), _defineProperty__default["default"](_ref, "".concat(COMPONENT_NAME.value, "--vertical"), vertical.value), _defineProperty__default["default"](_ref, STATUS.value.disabled, disabled.value), _ref)];
    });

...
export declare const Tabs: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "value" | "disabled" | "size" | "modelValue" | "theme" | "placement" | "dragSort" | "addable">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {

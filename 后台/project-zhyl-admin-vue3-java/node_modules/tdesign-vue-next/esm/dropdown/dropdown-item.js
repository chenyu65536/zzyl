...
var _DropdownItem = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      var _ref2;
      var classes = [dropdownItemClass.value, "".concat(dropdownItemClass.value, "--theme-").concat(props.theme), (_ref2 = {}, _defineProperty(_ref2, "".concat(dropdownItemClass.value, "--active"), props.active), _defineProperty(_ref2, "".concat(dropdownItemClass.value, "--disabled"), props.disabled), _ref2)];

...
import '../utils/dom.js';
import '../_chunks/dep-c3bfb3b8.js';
...
var THead = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var theadClasses = computed(function () {
      var _ref2;
      return [tableHeaderClasses.header, (_ref2 = {}, _defineProperty(_ref2, tableHeaderClasses.fixed, props.isFixedHeader), _defineProperty(_ref2, tableBaseClass.bordered, props.bordered && props.isMultipleHeader), _defineProperty(_ref2, tableHeaderClasses.multipleHeader, props.isMultipleHeader), _ref2)];
    });
    ...
    var getTableNode = function getTableNode(thead) {
      var parent = thead;
      while (parent) {
        var _parent, _parent$classList;
        parent = parent.parentNode;
        if ((_parent = parent) !== null && _parent !== void 0 && (_parent$classList = _parent.classList) !== null && _parent$classList !== void 0 && _parent$classList.contains("".concat(props.classPrefix, "-table"))) {
          break;
        }
      }
      return parent;
    ...
    var renderThNodeList = function renderThNodeList(rowAndColFixedPosition, thWidthList) {
      ...
      return _this.thList.map(function (row, rowIndex) {
        var thRow = row.map(function (col, index) {
          ...
          var thClasses = [thStyles.classes, customClasses, (_ref3 = {}, _defineProperty(_ref3, _this.tableHeaderClasses.thBordered, thBorderMap.get(col)), _defineProperty(_ref3, "".concat(_this.classPrefix, "-table__th-").concat(col.colKey), col.colKey), _defineProperty(_ref3, _this.tdAlignClasses[col.align], col.align && col.align !== "left"), _ref3)];

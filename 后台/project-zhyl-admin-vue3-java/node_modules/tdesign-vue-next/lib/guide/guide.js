...
import { defineComponent, toRefs, ref, computed, watch, onMounted, createVNode, Fragment, withDirectives, resolveDirective, nextTick, mergeProps } from 'vue';
    ...
    return function () {
      ...
      var renderTooltipBody = function renderTooltipBody() {
        ...
        if (typeof descBody === "string") ; else {
          createVNode(descBody, null, null);
        }

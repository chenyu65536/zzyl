...
import { getDefaultFormat, formatTime, formatDate, isValidDate } from '../../_common/js/date-picker/format.js';
...
import '../../_chunks/dep-cf3a45a4.js';
import 'lodash/chunk';
...
function useSingleValue(props) {
  ...
  var time = ref(formatTime(value.value, formatRef.value.timeFormat));
  var month = ref(dayjs(value.value).month() || new Date().getMonth());
  var year = ref(dayjs(value.value).year() || new Date().getFullYear());

...
import { defineComponent, inject, ref, computed, createVNode, mergeProps, isVNode } from 'vue';
  ...
  setup: function setup(props, _ref) {
    ...
    var renderOptionsContent = function renderOptionsContent(options) {
      return createVNode("ul", {
        ...
        return createVNode(_Option, mergeProps(omit(item, "$index"), isVirtual.value ? {
          rowIndex: item.$index,
          trs: trs,

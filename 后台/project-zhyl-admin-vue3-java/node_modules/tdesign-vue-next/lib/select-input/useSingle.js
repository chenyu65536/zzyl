...
function useSingle(props, context) {
  ...
  var renderSelectSingle = function renderSelectSingle(popupVisible) {
    ...
    return createVNode(Input, mergeProps({
      ...
      "inputClass": (_ref = {}, _defineProperty(_ref, "".concat(classPrefix.value, "-input--focused"), popupVisible), _defineProperty(_ref, "".concat(classPrefix.value, "-is-focused"), popupVisible), _ref)
    }), context.slots);
  };
  return {
    inputRef: inputRef,

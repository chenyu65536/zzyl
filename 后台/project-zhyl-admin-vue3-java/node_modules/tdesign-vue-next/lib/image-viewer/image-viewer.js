...
import { defineComponent, ref, computed, toRefs, watch, createVNode, Fragment, Teleport } from 'vue';
import { CloseIcon, ChevronDownIcon, ChevronLeftIcon } from 'tdesign-icons-vue-next';
...
var _ImageViewer = defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var wrapClass = computed(function () {
      return ["".concat(COMPONENT_NAME.value, "-preview-image"), _defineProperty({}, "".concat(classPrefix.value, "-is-hide"), !visibleValue.value)];
    });

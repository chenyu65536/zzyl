...
export declare const Calendar: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            value: {
                type: import("vue").PropType<import("./type").CalendarValue | import("./type").CalendarValue[]>;
            };
            week: {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "multiple" | "mode" | "format" | "theme" | "controllerConfig" | "isShowWeekendDefault" | "fillWithZero" | "preventCellContextmenu">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {

...
var _Input = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    return function () {
      ...
      var classes = [COMPONENT_NAME.value, props2.inputClass, (_ref2 = {}, _defineProperty(_ref2, SIZE.value[props2.size], props2.size !== "medium"), _defineProperty(_ref2, STATUS.value.disabled, disabled.value), _defineProperty(_ref2, STATUS.value.focused, focused.value), _defineProperty(_ref2, "".concat(classPrefix.value, "-is-").concat(tStatus.value), tStatus.value), _defineProperty(_ref2, "".concat(classPrefix.value, "-align-").concat(props2.align), props2.align !== "left"), _defineProperty(_ref2, "".concat(classPrefix.value, "-is-readonly"), props2.readonly), _defineProperty(_ref2, "".concat(COMPONENT_NAME.value, "--prefix"), prefixIcon || labelContent), _defineProperty(_ref2, "".concat(COMPONENT_NAME.value, "--suffix"), suffixIcon || suffixContent), _defineProperty(_ref2, "".concat(COMPONENT_NAME.value, "--focused"), focused.value), _defineProperty(_ref2, "".concat(COMPONENT_NAME.value, "--auto-width"), props2.autoWidth && !props2.keepWrapperWidth), _ref2)];

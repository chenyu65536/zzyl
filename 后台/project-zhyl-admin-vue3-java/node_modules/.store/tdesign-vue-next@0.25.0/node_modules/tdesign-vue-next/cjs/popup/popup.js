...
var _Popup = vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var overlayCls = vue.computed(function () {
      var _ref2;
      return ["".concat(prefixCls.value, "__content"), (_ref2 = {}, _defineProperty__default["default"](_ref2, "".concat(prefixCls.value, "__content--text"), typeof props2.content === "string"), _defineProperty__default["default"](_ref2, "".concat(prefixCls.value, "__content--arrow"), props2.showArrow), _defineProperty__default["default"](_ref2, commonCls.value.disabled, props2.disabled), _ref2), props2.overlayInnerClassName];
    });
    var hasTrigger = vue.computed(function () {
      return triggers.reduce(function (map, trigger2) {
        return _objectSpread(_objectSpread({}, map), {}, _defineProperty__default["default"]({}, trigger2, props2.trigger.includes(trigger2)));
      }, {});
    });
    ...
    function getOverlayStyle() {
      ...
      if (_typeof__default["default"](overlayStyle) === "object") {
        return overlayStyle;
      }
    }
    function updateOverlayInnerStyle() {
      ...
      } else if (_typeof__default["default"](overlayInnerStyle) === "object") {
    ...
    function updatePopper() {
      ...
      popper = core.createPopper(triggerEl.value, popperEl.value, {
    ...
    vue.watch(function () {
      ...
      if (visible2) {
        preventClosing(true);
        if (!hasDocumentEvent) {
          utils_dom.on(document, "click", handleDocumentClick, true);
        ...
        utils_dom.off(document, "click", handleDocumentClick, true);
  ...
  render: function render() {
    ...
    return vue.createVNode(popup_container["default"], {
      ...
      "default": function _default() {
        return utils_renderTnode.renderContent(_this, "default", "triggerElement");
      }
    });
  }
});

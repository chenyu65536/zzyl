...
var _Guide = vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var setHighlightLayerPosition = function setHighlightLayerPosition(highlighLayer) {
      var _getRelativePosition = guide_utils_getRelativePosition["default"](nextHighlightLayerElm.value, currentHighlightLayerElm.value),
    ...
    var showPopupGuide = function showPopupGuide() {
      var currentElement = guide_utils_getTargetElm["default"](currentStepInfo.value.element);
      nextHighlightLayerElm.value = currentElement;
      vue.nextTick(function () {
        guide_utils_getScrollParent.scrollToParentVisibleArea(nextHighlightLayerElm.value);
        setHighlightLayerPosition(highlightLayerRef.value);
        setHighlightLayerPosition(referenceLayerRef.value);
        guide_utils_scrollToElm["default"](nextHighlightLayerElm.value);
    ...
    return function () {
      ...
      var renderAction = function renderAction(mode) {
        ...
        return vue.createVNode("div", {
          ...
          "variant": "base",
          "onClick": handleSkip
        }, getCurrentCrossProps("skipButtonProps")), null), !hidePrev.value && !isFirst && vue.createVNode(button_index.Button, vue.mergeProps({
          "class": "".concat(COMPONENT_NAME.value, "__prev"),
          "theme": "primary",
          "size": buttonSize,
          "variant": "base",
          "onClick": handlePrev
        }, getCurrentCrossProps("prevButtonProps")), null), !isLast && vue.createVNode(button_index.Button, vue.mergeProps({
          "class": "".concat(COMPONENT_NAME.value, "__next"),
          "theme": "primary",
          "size": buttonSize,
          "variant": "base",
          "onClick": handleNext
        }, getCurrentCrossProps("nextButtonProps")), null), isLast && vue.createVNode(button_index.Button, vue.mergeProps({
      ...
      var renderPopupGuide = function renderPopupGuide() {
        ...
        return vue.createVNode(popup_index.Popup, {
          ...
          "overlayInnerClassName": _defineProperty__default["default"]({}, "".concat(COMPONENT_NAME.value, "__popup--content"), !!content),

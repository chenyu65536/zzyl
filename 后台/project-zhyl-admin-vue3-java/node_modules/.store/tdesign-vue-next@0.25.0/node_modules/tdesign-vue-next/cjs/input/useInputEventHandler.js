...
function useInputEventHandler(props, isHover, innerValue) {
  var handleKeydown = function handleKeydown(e) {
    ...
    if (code === "Enter" || code === "NumpadEnter") {
      var _props$onEnter;
      (_props$onEnter = props.onEnter) === null || _props$onEnter === void 0 ? void 0 : _props$onEnter.call(props, e.currentTarget.value, {
        e: e
      });
    } else {
      var _props$onKeydown;
      (_props$onKeydown = props.onKeydown) === null || _props$onKeydown === void 0 ? void 0 : _props$onKeydown.call(props, e.currentTarget.value, {
        e: e
      });
    }
  };
  var handleKeyUp = function handleKeyUp(e) {
    var _props$onKeyup;
    if (props.disabled) return;
    (_props$onKeyup = props.onKeyup) === null || _props$onKeyup === void 0 ? void 0 : _props$onKeyup.call(props, e.currentTarget.value, {
      e: e
    });
  };
  var handleKeypress = function handleKeypress(e) {
    ...
    if (props.disabled) return;
    (_props$onKeypress = props.onKeypress) === null || _props$onKeypress === void 0 ? void 0 : _props$onKeypress.call(props, e.currentTarget.value, {
      e: e
    });
  };

...
var _Submenu = vue.defineComponent({
  ...
  setup: function setup(props2, ctx) {
    ...
    var classes = vue.computed(function () {
      var _ref;
      return ["".concat(classPrefix.value, "-submenu"), (_ref = {}, _defineProperty__default["default"](_ref, "".concat(classPrefix.value, "-is-disabled"), props2.disabled), _defineProperty__default["default"](_ref, "".concat(classPrefix.value, "-is-opened"), isOpen.value), _ref)];
    });
    var popupClass = vue.computed(function () {
      return ["".concat(classPrefix.value, "-menu__popup"), "".concat(classPrefix.value, "-menu__popup--").concat(theme.value), "".concat(classPrefix.value, "-is-").concat(isHead ? "horizontal" : "vertical"), _defineProperty__default["default"]({}, "".concat(classPrefix.value, "-is-opened"), popupVisible.value), "narrow-scrollbar"];
    });
    var submenuClass = vue.computed(function () {
      var _ref3;
      return ["".concat(classPrefix.value, "-menu__item"), "".concat(classPrefix.value, "-menu__item-spacer"), "".concat(classPrefix.value, "-menu__item-spacer--").concat(isHead && !isNested.value ? "bottom" : "right"), (_ref3 = {}, _defineProperty__default["default"](_ref3, "".concat(classPrefix.value, "-is-disabled"), props2.disabled), _defineProperty__default["default"](_ref3, "".concat(classPrefix.value, "-is-opened"), isOpen.value), _defineProperty__default["default"](_ref3, "".concat(classPrefix.value, "-is-active"), isActive.value), _ref3)];
    });
  ...
  methods: {
    renderPopup: function renderPopup(triggerElement) {
      ...
      var overlayInnerStyle = this.isNested && this.isHead ? {
        marginLeft: "16px"
      } : _defineProperty__default["default"]({}, "margin-".concat(this.isHead ? "top" : "left"), "20px");
      ...
      var realPopup = vue.createVNode(popup_index.Popup, {
        "overlayInnerClassName": _toConsumableArray__default["default"](this.popupClass),

...
var SorterButton = vue.defineComponent({
  ...
  methods: {
    getSortIcon: function getSortIcon(direction, activeClass) {
      ...
      var sortClassName = [activeClass, this.tableSortClasses.sortIcon, this.tableSortClasses.iconDirection[direction], _defineProperty__default["default"]({}, this.negativeRotate180, direction === "asc")];

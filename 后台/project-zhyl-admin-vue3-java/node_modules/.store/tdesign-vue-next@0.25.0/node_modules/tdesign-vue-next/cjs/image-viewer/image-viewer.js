...
var _ImageViewer = vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var wrapClass = vue.computed(function () {
      return ["".concat(COMPONENT_NAME.value, "-preview-image"), _defineProperty__default["default"]({}, "".concat(classPrefix.value, "-is-hide"), !visibleValue.value)];
    });
      ...
      return vue.createVNode(vue.Fragment, null, [renderTNodeJSX("trigger", {
        ...
        "default": function _default() {
          return [visibleValue.value && vue.createVNode("div", {
            ...
            "size": "24px"
          }, null))]), vue.createVNode(imageViewer_base_ImageViewerUtils["default"], {
            "onZoomIn": onZoomIn,
            "onZoomOut": onZoomOut,
            "onMirror": onMirror,
            "onReset": onRest,

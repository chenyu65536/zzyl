  ...
  setup: function setup(props) {
    ...
    var getStyle = function getStyle() {
      ...
      for (; i < props.navs.length; i++) {
        ...
        offset += ((_props$navs$i = props.navs[i]) === null || _props$navs$i === void 0 ? void 0 : (_props$navs$i$el = _props$navs$i.el) === null || _props$navs$i$el === void 0 ? void 0 : _props$navs$i$el["client".concat(utils_helper.firstUpperCase(sizePropName))]) || 0;
      }
      if (!props.navs[i]) return {};
      return _ref3 = {}, _defineProperty__default["default"](_ref3, offsetPropName, "".concat(offset, "px")), _defineProperty__default["default"](_ref3, sizePropName, "".concat(((_props$navs$i$el2 = props.navs[i].el) === null || _props$navs$i$el2 === void 0 ? void 0 : _props$navs$i$el2["client".concat(utils_helper.firstUpperCase(sizePropName))]) || 0, "px")), _ref3;
    };

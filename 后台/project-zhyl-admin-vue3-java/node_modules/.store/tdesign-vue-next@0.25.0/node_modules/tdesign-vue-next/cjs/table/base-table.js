...
var _BaseTable = vue.defineComponent({
  ...
  setup: function setup(props2, context) {
    ...
    var _usePagination = table_hooks_usePagination["default"](props2),
    ...
    var tableElmClasses = vue.computed(function () {
      return [[tableLayoutClasses[props2.tableLayout]], _defineProperty__default["default"]({}, tableBaseClass.fullHeight, props2.height)];
    });
    ...
    var _toRefs = vue.toRefs(props2),
      data = _toRefs.data;
    var _ref4 = type === "virtual" ? hooks_useVirtualScroll["default"]({
  ...
  render: function render() {
    ...
    var renderAffixedHeader = function renderAffixedHeader() {
      ...
      return !!(_this.isVirtual || _this.headerAffixedTop) && (_this.headerAffixedTop ? vue.createVNode(affix_index.Affix, vue.mergeProps({
        "offsetTop": 0
    ...
    var affixedHeader = Boolean((this.headerAffixedTop || this.isVirtual) && this.tableWidth) && vue.createVNode("div", {
      ...
      "class": ["scrollbar", _defineProperty__default["default"]({}, this.tableBaseClass.affixedHeaderElm, this.headerAffixedTop || this.isVirtual)]

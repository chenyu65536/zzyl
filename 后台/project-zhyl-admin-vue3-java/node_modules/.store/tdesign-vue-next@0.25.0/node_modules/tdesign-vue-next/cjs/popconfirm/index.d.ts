...
export declare const Popconfirm: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "visible" | "modelValue" | "theme" | "placement" | "destroyOnClose" | "showArrow" | "defaultVisible" | "cancelBtn" | "confirmBtn">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {

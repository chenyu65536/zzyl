...
function useSingleValue(props) {
  ...
  var time = vue.ref(_common_js_datePicker_format.formatTime(value.value, formatRef.value.timeFormat));
  var month = vue.ref(dayjs__default["default"](value.value).month() || new Date().getMonth());
  var year = vue.ref(dayjs__default["default"](value.value).year() || new Date().getFullYear());

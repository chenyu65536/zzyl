...
exports.collectRules = exports.rules = void 0;
const baseRules = [
    {
...
function collectRules(category) {
    return exports.rules.reduce((obj, rule) => {
        if ((!category || rule.meta.docs.categories.includes(category)) &&
...
exports.collectRules = collectRules;
